...
<body>
    ...
    <h1 class="titulo-materias">Materias Contabilidad</h1>
    <table id="tabla-materias" border="1" style="margin: 0 auto;">
        ...
        <tbody>
            ...
            include 'info_contabilidad.php';


            $sql_ad = "SELECT codigo, materia, creditos, requisitos FROM contabilidad;";
    ...
    <script>
        function guardarTabla() {
            ...
            $.ajax({
                url: '/php/checkbox_conta.php', // Reemplaza por la ruta correcta a tu script PHP
                method: 'POST',
                data: {
