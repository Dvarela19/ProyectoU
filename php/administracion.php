...
<body>
    ...
    <h1 class="titulo-materias">Materias Administracion</h1>
    <table id="tabla-materias" border="1" style="margin: 0 auto;">
        ...
        <tbody>
            ...
            include 'info_administracion.php';


            $sql_ad = "SELECT codigo, materia, creditos, requisitos FROM administracion;";
    ...
    <script>
        function guardarTabla() {
            ...
            $.ajax({
                url: '/php/checkbox_admi.php', // Reemplaza por la ruta correcta a tu script PHP
                method: 'POST',
                data: {
