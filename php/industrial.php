...
<body>
    ...
    <h1 class="titulo-materias">Materias Industrial</h1>
    <table id="tabla-materias" border="1" style="margin: 0 auto;">
        ...
        <tbody>
            ...
            include 'info_industrial.php';


            $sql_ad = "SELECT codigo, materia, creditos, requisitos FROM industrial;";
    ...
    <script>
        function guardarTabla() {
            ...
            $.ajax({
                url: '/php/checkbox_indu.php', // Reemplaza por la ruta correcta a tu script PHP
                method: 'POST',
                data: {
